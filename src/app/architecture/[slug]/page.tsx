  ...
  return (
    <main className="min-h-screen bg-bg-dark text-text-primary selection:bg-accent/30 pb-16">
      ...
      <div className="max-w-5xl mx-auto px-6 mt-12 space-y-16">
        ...
        {/* CTA row */}
        <div className="max-w-5xl mx-auto px-6 mt-12 pt-10 border-t border-border-subtle flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
